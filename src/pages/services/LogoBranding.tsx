  ...
  useEffect(() => {
    async function fetchSubServices() {
      try {
        setLoading(true);
        setError(null);
        const apiUrl = `${apiBaseUrl}/service_master/logo-branding-services`;
  ...
  useEffect(() => {
    async function fetchPricingPlans() {
      try {
        ...
        // Fetch pricing data for 'Logo & Branding Services'
        const apiUrl = `${apiBaseUrl}/pricing_master/logo-branding-services`;
        const res = await fetch(apiUrl);
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-[calc(100vh-0px)] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6">Logo & Branding</h1>
              <p className="text-xl text-gray-600 mb-8">
                Build a memorable brand identity with our logo design and
                branding services, crafted to make your business stand out.
              </p>
              <Link to="/contact">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive logo and branding services to help your business
              stand out and build a memorable identity.
            </p>
          </div>
