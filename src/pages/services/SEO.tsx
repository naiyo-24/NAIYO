  ...
  useEffect(() => {
    async function fetchSubServices() {
      try {
        setLoading(true);
        setError(null);
        const apiUrl = `${apiBaseUrl}/service_master/seo-services`;
  ...
  useEffect(() => {
    async function fetchPricingPlans() {
      try {
        ...
        // Fetch pricing data for 'SEO Services'
        const apiUrl = `${apiBaseUrl}/pricing_master/seo-services`;
        const res = await fetch(apiUrl);
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Boost your online visibility and rankings with our expert SEO
                services, including on-page, off-page, and technical
                optimization.
              </p>
              <Link to="/contact">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive SEO services to boost your online presence and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 text-center">
              We leverage industry-leading SEO tools, analytics platforms, and
              optimization technologies to deliver measurable, scalable, and
              high-impact search engine results for your business.
            </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Let's discuss your business goals and set up an SEO strategy that
            drives traffic, improves visibility, and grows your brand online.
          </p>
