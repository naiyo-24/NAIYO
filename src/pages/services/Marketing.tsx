      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-[calc(100vh-0px)] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6">Marketing</h1>
              <p className="text-xl text-gray-600 mb-8">
                Grow your business with our comprehensive marketing solutions,
                including digital campaigns, social media management, and
            ...
            <div>
              <img
                src="https://images.pexels.com/photos/266176/pexels-photo-266176.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt="Marketing"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              End-to-end marketing solutions to help your business grow, engage
              your audience, and achieve measurable results online.
            </p>
          </div>
              ...
              subServices.map((service, idx) => {
                ...
                return (
                  <SubServiceCard
                    ...
                    subService={
                      service.sub_service || service.main_service || "Marketing"
                    }
