...
export default function ServersAndHosting() {
  // Navigation hook
  ...
  useEffect(() => {
    async function fetchSubServices() {
      try {
        setLoading(true);
        setError(null);
        const apiUrl = `${apiBaseUrl}/service_master/servers-and-hosting-services`;
  ...
  useEffect(() => {
    async function fetchPricingPlans() {
      try {
        ...
        // Fetch pricing data for 'Servers And Hosting Services'
        const apiUrl = `${apiBaseUrl}/pricing_master/servers-and-hosting-services`;
        const res = await fetch(apiUrl);
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-[calc(100vh-0px)] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6">Servers & Hosting</h1>
              <p className="text-xl text-gray-600 mb-8">
                Reliable server setup, cloud hosting, and infrastructure
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive servers & hosting services to help your business
              thrive online.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 text-center">
              We use cutting-edge technologies to deliver secure, scalable, and
              high-performance server and hosting solutions for your business.
            </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to host your services?
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Let's discuss your project and host a service that drives results
            for your business.
          </p>
