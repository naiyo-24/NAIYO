  ...
  useEffect(() => {
    async function fetchSubServices() {
      try {
        setLoading(true);
        setError(null);
        const apiUrl = `${apiBaseUrl}/service_master/domain-registration-services`;
  ...
  useEffect(() => {
    async function fetchPricingPlans() {
      try {
        ...
        // Fetch pricing data for 'Domain Registration Services'
        const apiUrl = `${apiBaseUrl}/pricing_master/domain-registration-services`;
        const res = await fetch(apiUrl);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              End-to-end domain registration and management services to help
              your business establish and protect its online identity with ease.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 text-center">
              ...
              technologies to deliver reliable, secure, and scalable domain
              registration and management solutions for your business.
            </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Let's discuss your business needs and set up a domain registration
            solution that establishes and protects your brand online.
          </p>
